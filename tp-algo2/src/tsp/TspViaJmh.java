...
public class TspViaJmh {
	...
	static Options config(boolean withJit) {
		int nbOfCities = withJit ? 100000 : 20000;
		ChainedOptionsBuilder ob = new OptionsBuilder().warmupIterations(1).measurementIterations(1).forks(1)
				.mode(Mode.AverageTime).param("algoId", "2", "0", "170", "120")
