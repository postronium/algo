...
public class BTreeItr<T> {
    ...
    public BTreeItr<T> up() {
        assert (!isRoot());
        BTreeItr<T> newItr = new BTreeItr<T>(this.whole);
        newItr.up = this.up.parent;
        newItr.down = this.up;
        newItr.isLeftArc = (newItr.up.left == newItr.down) ;
        return newItr;
    }
    ...
    public BTreeItr<T> left() {
        assert (!isBottom());
        BTreeItr<T> r = new BTreeItr<T>(whole);
        r.up = down;
        r.down = down.left;
        r.isLeftArc = true;
        return r;
    ...
    public BTreeItr<T> alias() {
        BTreeItr<T> t = new BTreeItr<T>(whole);
        t.whole = whole;
        t.up = up;
        t.down = down;
    ...
    public void insert(T elt) {
        ...
        this.down = new BTNode<T>(elt, null, null, this.up);
        if(!isRoot()){
            if(this.isLeftArc())
     ...
     */
    public BTree<T> cut() {
        BTree<T> rtrnTree = new BTree<T>();
        rtrnTree.root = this.down;
        if(rtrnTree.root != null)
            rtrnTree.root.parent = null;
        this.down = null;
