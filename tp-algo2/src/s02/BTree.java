...
//10 Modifications for implementing Genericity in BTree.java
//and 17 Header modified for BTreeItr.java
...
public class BTree<T> {
    ...
    private String toStr(BTNode<T> n) {
        if(n == null) return "()";
        String res = "";
        res += String.format("(%s,%d,%s)",toStr(n.left), n.elt, toStr(n.right));
        return res;
    }
