...
public class BTreeItr<E> {
	...
	public static int nRotateLeft = 0;
	public static int nRotateRight = 0;
	// ------------------------------------------------------------
	...
	/**
	 * Moves the neighboring nodes according to a left rotation. PRE: hasRight()
	 */
	...
	/**
	 * Moves the neighboring nodes according to a right rotation. PRE: hasLeft()
	 */
	...
	public static void printStatistics() {
		System.out.println("nRotateLeft : " + nRotateLeft);
		System.out.println("nRotateRight : " + nRotateRight);
	}
