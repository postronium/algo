...
public class DisjSetsTestJU {
	...
	static class DisjSetsNaive {
		...
		public boolean equals(Object o) {
			if (!(o instanceof DisjSetsNaive))
				return false;
			DisjSetsNaive other = (DisjSetsNaive) o;
			if (other.sets.size() != sets.size())
				return false;
			for (Set<Integer> s : sets) {
				boolean found = false;
	...
	private void testDisjSets(int n) {
		...
		System.out.println("Test unicity");
		System.out.println("    " + b.toString() + " " + b.isUnique());
		System.out.println("    " + d.toString() + " " + d.isUnique());
		assertTrue(d.isUnique());
	}
